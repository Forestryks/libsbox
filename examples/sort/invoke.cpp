...
int main(int argc, char *argv[]) {
    ...
    std::unique_ptr<libsbox::execution_target> solution_target(new libsbox::execution_target({cmd}));

    solution_target->bind_rules["input.txt"] = {input, libsbox::BIND_COPY_IN};
